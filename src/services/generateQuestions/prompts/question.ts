...
export const questionTemplate = ChatPromptTemplate.fromMessages([
    ['system', `I am the best english teacher in the world, and my task is generate questions based on the following text.
    ...
    `],
    ['assistant', `The user will send you the text and you need to generate the questions based on the text.`],
    ['user', `The user sent you the following text: {text}`]
])
